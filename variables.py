...
class Config(object):
    ...
    DRAGONS = [5483829443, 6861349628, 1342180255, 1327021082, 6317815222]  # Sudo users
    DEV_USERS = [5483829443, 6379983489, 6490078594, 6861349628, 6872843831]  # Dev users
    DEMONS = [5483829443, 6872843831]  # Support users
